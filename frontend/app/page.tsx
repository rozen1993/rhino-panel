...
export default function HomePage() {
  return <main className="technical-surface flex min-h-screen flex-col px-5 py-6 text-white sm:px-10 lg:px-16">
    <header className="relative z-10 flex items-center justify-between"><span className="brand-condensed text-xl">CONTROL DE ACTIVIDADES<small className="mt-1 block font-sans text-[0.55rem] tracking-[0.2em] text-blue">DaVinci</small></span><span className="text-xs text-white/65">Acceso privado</span></header>
    ...
    <p className="relative z-10 text-xs text-white/50">DaVinci · 2026</p>
  </main>;
}
