...
const styles: Record<InternalStatus, string> = { Programada: "border-blue/40 bg-blue/10 text-[#08718a]", "En proceso": "border-process bg-process text-white", Entregada: "border-green/40 bg-green/10 text-[#2d760d]" };
